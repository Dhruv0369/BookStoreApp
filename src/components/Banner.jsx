            ...
            <div className='max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-10'>
                <div className='w-full order-2 md:order-1 md:w-1/2 mt-12 md:mt-32'>
                    <div className='space-y-12'>
                        ...
                        <p className='text-xl'>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Tenetur, a accusamus explicabo alias magnam doloribus deleniti adipisci ipsum aut, illum sed quis architecto? Libero, nemo.
                        </p>
                ...
                <div className='order-1 w-full md:w-1/2'>
                    <img src={banner} className='w-89 h-89' alt="" />
                </div>
            </div>
        </>
    )
